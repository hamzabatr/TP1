...
class ListNeighborsAdapter(items: List<Neighbor>,
                           private val listNeighborHandler: ListNeighborHandler) : RecyclerView.Adapter<ListNeighborsAdapter.ViewHolder>()
{
